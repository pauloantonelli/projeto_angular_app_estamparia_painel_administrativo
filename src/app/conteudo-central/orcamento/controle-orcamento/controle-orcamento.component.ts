...
export class ControleOrcamentoComponent implements OnInit, OnDestroy {
  ...
  maisTipoServicos() {
    this.formulario.servicos.tiposDeServicos.push('');
    this.formulario.servicos.imagens.push('');
  }
  menosTipoServicos(posicao) {
    this.formulario.servicos.tiposDeServicos.splice(posicao, 1);
    this.formulario.servicos.imagens.splice(posicao, 1);
  }
